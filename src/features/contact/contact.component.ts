        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-1">Portfolio</h3>
                <a [href]="cvData.portfolio" target="_blank" class="text-[var(--color-primary)] hover:text-[var(--color-secondary)] transition-colors break-all">
                  {{ cvData.portfolio }}
                </a>
              </div>
            </div>
          ...
          <div class="border-t pt-8">
            ...
            <div class="flex justify-center space-x-6">
              <a href="https://linkedin.com/in/konstantinos-foulidis" target="_blank"
              ...
              <a href="https://github.com/konstantinos-foulidis" target="_blank"
                 class="w-14 h-14 bg-[var(--color-primary)] rounded-lg flex items-center justify-center hover:bg-[var(--color-secondary)] transition-all duration-200">
                <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
